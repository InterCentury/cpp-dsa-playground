...
int create_linked_list_function(node **head)
    ...
    void display_data_linked_list_function(node *head)
         ...
         void deletion_process_of_the_last_node(node *head)
              { 
                node *temp_pointing_to_the_last_node = head;
                while(temp_pointing_to_the_last_node -> next ->next != nullptr)
                     {
                      temp_pointing_to_the_last_node = temp_pointing_to_the_last_node -> next;
                     }
                delete temp_pointing_to_the_last_node -> next; temp_pointing_to_the_last_node ->next = nullptr;
              } 
int main(){
  node *head = nullptr;
  ...
  //pass the head for delete the 1st node of the linked list 
      deletion_process_of_the_last_node(head);
  // let's see what happens after delete the 1st node of the linked list
       cout << endl << endl << "After delete the last node of the linked list ," ;
         display_data_linked_list_function(head); 
